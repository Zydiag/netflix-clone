      ...
      <div className="relative w-5/6 mx-auto max-w-2xl rounded-md overflow-hidden">
        ...
        >
          <div className="relative h-96">
            ...
            ></video>
            <div
              className="cursor-pointer absolute top-3 right-3 h-10 w-10 rounded-full bg-black flex bg-opacity-70 items-center justify-center"
              onClick={handleClose}
            >
          ...
          <div className="px-12 py-8">
            <div className="flex gap-4 md:gap-10">
              ...
              <p className="text-white font-bold text-lg ">{data?.duration}</p>
